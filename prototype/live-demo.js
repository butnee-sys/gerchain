...
async function run(){runBtn.disabled=true;reset();timer=setInterval(()=>render(seconds+1),1000);try{
 ...
 clearInterval(timer);document.getElementById("kpiBadge").textContent=c.within_two_minutes?"PASS ≤ 120s":"OVER 120s";document.getElementById("systemStatus").textContent="LIVE COMPLETE";
