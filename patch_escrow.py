...
start_marker = '@app.post("/api/v1/escrow/create", response_model=dict)'
end_marker = '@app.post("/api/v1/evidence/submit")'

start = text.find(start_marker)
end = text.find(end_marker)

if start == -1:
    raise SystemExit("ESCROW CREATE ROUTE NOT FOUND")

if end == -1:
    raise SystemExit("EVIDENCE SUBMIT ROUTE NOT FOUND")

replacement = '''@app.post("/api/v1/escrow/create", response_model=dict)
...
print("ESCROW HARDENING APPLIED")