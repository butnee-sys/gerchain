...
**Current main commit under audit:** `bdfdb3b814a07bea42708fe3c687b6fa0b726a6b`
...
| CORE/SHUUD scope boundary | GREEN | Explicit boundary workflow/documentation; SHUUD failures excluded from CORE verdict |
...
| Main branch protection governance | MISSING / UNVERIFIED | Current GitHub branch metadata reports protection disabled; administrative verification is still required |
| Post-merge main workflow evidence | UNVERIFIED | Commit is on `main`; commit-associated workflow endpoint returned no runs |
