"""Explicit Multi-Connector Adapter boundary.

The I2B Gateway routes to this boundary. Concrete connector adapters are
registered here and are never imported by application code or the Gateway.
"""
...
class MultiConnectorAdapter:
    """Governed participant-to-connector dispatch boundary."""
    ...
    def register(self, adapter: ConnectorAdapter, *, credential: str,
    ...
    def rotate_credential(self, connector_id: str, *, credential: str,
        ...
        current = self._credentials[connector_id]
...
__all__ = ["ConnectorCredential", "ConnectorAdapter", "GatewayAuditEvent", "MultiConnectorAdapter"]
