-- Canonical production persistence required by the EAI value-flow boundary.
-- This migration is additive/reconciling: it upgrades the legacy escrow schema
-- and creates the single authoritative Ledger/Witness/Outbox/Idempotency stores.
