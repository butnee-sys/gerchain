-- Canonical production persistence for Ledger + Escrow + Witness + Outbox + Idempotency.
-- This migration is additive/idempotent and upgrades the legacy escrow table.
