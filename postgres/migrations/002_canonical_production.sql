-- Canonical production persistence for EAI / value-truth boundary.
-- Additive migration: preserves existing escrow rows and creates the
-- authoritative Ledger, Witness, Idempotency and transactional Outbox tables.
