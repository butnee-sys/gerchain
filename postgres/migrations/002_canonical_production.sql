-- Canonical production persistence migration.
-- Extends the legacy escrow table and creates the authoritative value-flow
-- tables used by GerchainRuntime production mode.
