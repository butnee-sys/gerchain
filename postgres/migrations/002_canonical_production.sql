...
-- This migration extends the legacy escrow table and creates the single
-- authoritative Ledger, Witness, Idempotency and transactional Outbox stores.
...
CREATE INDEX IF NOT EXISTS ix_gerchain_outbox_events_state_lease
