-- Canonical production runtime persistence.
-- Extends the legacy escrow table without changing existing value data.
-- The migration is intentionally fail-closed for pre-existing rows whose
-- canonical metadata cannot be derived safely.
