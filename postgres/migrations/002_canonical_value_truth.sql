-- Canonical production value-truth schema.
-- Extends the legacy escrow table without creating a second authority.
...
ALTER TABLE escrows
    ALTER COLUMN refund_destination DROP DEFAULT;

-- The legacy state constraint only allowed CREATED/LOCKED/RELEASED.
