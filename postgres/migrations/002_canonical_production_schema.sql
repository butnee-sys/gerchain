-- Canonical production persistence schema for EAI value flow.
-- Expands the legacy escrow table and creates the single authoritative
-- Ledger/Witness/Outbox/Idempotency boundaries used by the production runtime.
