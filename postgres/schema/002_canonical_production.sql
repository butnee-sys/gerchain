...
-- Extends the legacy escrow table into the canonical escrow aggregate and
-- creates the single authoritative Ledger, Witness, Idempotency and Outbox stores.
...
ALTER TABLE escrows
    ADD CONSTRAINT escrows_canonical_state_check
