-- Canonical production persistence for GerChain value flow.
-- Applies after 001_concurrency.sql.
-- One authoritative Ledger, Escrow aggregate, Witness, Outbox and Idempotency path.
...
ALTER TABLE escrows ALTER COLUMN amount TYPE NUMERIC(38,8) USING amount::NUMERIC(38,8);
