...
-- Extends the legacy escrow table without creating a second escrow authority.
-- Canonical value authority: gerchain_ledger_accounts / gerchain_ledger_movements.
