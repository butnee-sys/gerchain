-- Canonical production persistence alignment for EA-35.
-- This migration is intentionally explicit: SQLAlchemy create_all() does not alter
...
-- Transaction-participating canonical outbox.
