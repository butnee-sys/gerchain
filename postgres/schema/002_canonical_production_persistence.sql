-- Canonical production persistence baseline for EAI / value-flow authority.
-- This migration upgrades the existing escrow shape and creates the single
-- production-authoritative Ledger, Witness, Outbox and Idempotency stores.
