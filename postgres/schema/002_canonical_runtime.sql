...
-- EA-35.13: aligns PostgreSQL schema with the canonical durable runtime.
-- Apply once after 001_concurrency.sql. This migration is additive except
-- for the legacy escrow state constraint, which is widened in-place.
