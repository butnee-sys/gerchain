-- Canonical GerChain production persistence
-- Extends the legacy escrow table into the canonical aggregate and adds
-- the authoritative Ledger, Witness, Outbox and Idempotency stores.
