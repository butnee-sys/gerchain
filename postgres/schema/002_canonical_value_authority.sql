-- EA-35 canonical production persistence migration.
-- Idempotent PostgreSQL migration for the canonical value-flow graph.
-- Does not delete legacy tables; authority is frozen separately.
