...
-- Extends the legacy escrow schema and creates the authoritative value/evidence stores.
...
CREATE INDEX IF NOT EXISTS ix_gerchain_ledger_movements_created
    ON gerchain_ledger_movements (created_at);
