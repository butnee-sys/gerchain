-- Canonical production value-flow persistence
-- Extends the initial escrow schema and establishes one authoritative
-- Ledger, Witness, Outbox, and Idempotency path.
