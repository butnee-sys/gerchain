-- Canonical production persistence for the GerChain value-flow boundary.
-- This migration extends the legacy escrow table without creating a second
...
CREATE INDEX IF NOT EXISTS ix_gerchain_transaction_witnesses_escrow
