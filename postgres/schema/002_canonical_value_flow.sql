-- GerChain canonical value-flow persistence
-- Additive migration for the production authority defined by EA-34/EA-35.
-- Safe to run after 001_concurrency.sql. No value movement occurs here.
