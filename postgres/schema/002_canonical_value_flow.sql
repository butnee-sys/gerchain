-- Canonical production persistence upgrade for the durable value-flow boundary.
-- Safe on databases created by 001_concurrency.sql.
-- This migration does not move value; it only establishes canonical storage.
