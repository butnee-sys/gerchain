-- Canonical value-flow persistence for the production GerChain runtime.
-- Applied after 001_concurrency.sql.
-- Legacy tables remain for compatibility; these tables are the sole production
-- value-flow authorities for the canonical runtime.
