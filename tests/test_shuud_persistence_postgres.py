...
def test_shuud_persistence_postgres_round_trip_and_verified_recovery():
    store = _store()
    ...
    loaded = store.load_snapshot(incident_id)
...
def test_shuud_persistence_postgres_rejects_tampered_witness_snapshot():
    store = _store()
...
def test_shuud_persistence_postgres_update_and_delete():
    store = _store()
