...
class EXIMConnectorAdapter:
    ...
    def create_witness_chain(
        ...
        *,
        ...
        return self._port_import.create_witness_chain(
    ...
    def release_escrow(
        ...
        *,
        ...
        return self._port_import.release_escrow(
            escrow,
    ...
    def export_status(self, *, status: Mapping[str, Any]) -> Any:
        return self._port_export.status(status=status)
    ...
    def export_evidence_status(self, *, evidence: Mapping[str, Any]) -> Any:
        return self._port_export.evidence_status(evidence=evidence)

    def export_audit_event(self, *, event: Mapping[str, Any]) -> Any:
        return self._port_export.audit_event(event=event)
